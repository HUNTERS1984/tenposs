...
<aside class="right-side">
    ...
    <section class="content modal-global-redesign">
        ...
        <div class="col-lg-12">
            <div class="btn-menu">
                <a href="#" class="btn-3" data-keyboard="false" data-toggle="modal" data-target="#AddMenu">
                  <i class="glyphicon glyphicon-plus"></i> カテゴリ追加
                </a>
                <a href="#" class="btn-4" data-keyboard="false" data-toggle="modal" data-target="#DeleteConfirm">
                    ...
                    <table class="table accept_01">
                        ...
                        @foreach($list_staff_cat as $cat)
                            <tr>
                                ...
                                <td width="15%" class="center"><a href="{{route('admin.staff.editcat',['staff_id'=>$cat->id])}}" title="">編集</a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
