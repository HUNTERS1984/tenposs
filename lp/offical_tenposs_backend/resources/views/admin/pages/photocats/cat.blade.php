...
<aside class="right-side">
    ...
    <section class="content modal-global-redesign">
        ...
        <div class="col-lg-12">
            <div class="btn-menu">
                <a href="#" data-keyboard="false" data-keyboard="false" class="btn-3" data-toggle="modal" data-target="#AddMenu">
                  <i class="glyphicon glyphicon-plus"></i> カテゴリ追加
                </a>
                <a href="#" data-keyboard="false" data-keyboard="false" class="btn-4" data-toggle="modal" data-target="#DeleteConfirm">
