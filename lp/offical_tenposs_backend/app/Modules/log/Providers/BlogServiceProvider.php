...
class BlogServiceProvider extends ServiceProvider
{
	...
	public function register()
	{
		...
		Lang::addNamespace('log', realpath(__DIR__.'/../Resources/Lang'));
		View::addNamespace('log', base_path('resources/views/vendor/log'));
		View::addNamespace('log', realpath(__DIR__.'/../Resources/Views'));
	}
