            ...
            if (Input::get('store_id') == 0){
                ...
                if ($total_coupon > 0) {
                    ...
                    {   
                        ...
                        $coupons[$i]['image_url'] = $this->convertRelativeToAbsoluteURL(Config::get('api.media_base_url'), $coupons[$i]['image_url'])://  Config::get('api.media_base_url').$coupons[$i]['image_url'];
