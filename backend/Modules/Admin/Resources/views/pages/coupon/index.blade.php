				...
				<div class="row">
							...
							<div class="wrap-content-prview">
								...
								<div class="content-preview">
									...
									<div class="each-coupon clearfix">
										<img src="{{url('/').'/'.$coupon->image_url}}" class="img-responsive img-prview">
										<div class="inner-preview">
											<p class="title-inner" style="font-size:9px; color:#14b4d2">{{$coupon->coupon_type->name}}</p>
											<p class="sub-inner" style="font-weight:600px; font-size:9px;">{{$coupon->title}}</p>
											<p class="text-inner" style="font-size:9px;">{{$coupon->description}}</p>
										</div>
									</div>
									@endforeach
								</div>
					...
					<div class="col-lg-8">
						<div class="wrap-btn-content">
							<a href="javascript:avoid()" class="btn-me btn-hong" data-toggle="modal" data-target="#AddCouponType">クーポンタイプ追加</a>
							<a href="javascript:avoid()" class="btn-me btn-xanhduongnhat" data-toggle="modal" data-target="#AddCoupon">クーポン追加</a>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	      	...
	      	{{Form::open(array('route'=>array('admin.coupon.destroy',0),'method'=>'DELETE'))}}
				...
				<input type="submit" class="btn btn-danger" value="削除"  onclick="return confirm('Are you sure you want to delete this item?');">
			{{Form::close()}}
	      </div>
	    </div>
