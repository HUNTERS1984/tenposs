...
class UploadHandler
{
    ...
    public function __construct($app_setting_id = null,$options = null, $initialize = true, $error_messages = null)
    {
        ...
        Log::info($this->error_messages);
        if ($initialize) {
            $this->initialize($app_setting_id);
        }
    }

    protected function initialize($app_setting_id)
    {
        ...
        if ($upload) {
            if (is_array($upload['tmp_name'])) {
                ...
                foreach ($upload['tmp_name'] as $index => $value) {
                    ...
                    Log::info('file_name2:' . json_encode($files));
                }
            } else {
                ...
                Log::info('file_name22:' . json_encode($files));
            }
        }
